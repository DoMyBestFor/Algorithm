...
public class S1223ver2 {
	/**
	 * SW 1223에서 추가하고 싶은 기능
	 * 1. 두 자리수 이상의 피연산자가 나올때도 처리 가능 V 완료
	 * 2. 피연산자가 음수로 주어질 때 ex ) (-1) * (-1) 도 처리 가능
	 * 3. 괄호로 우선순위를 바꿔줄 때도 처리 가능
	 */
	static int N;
	...
	public static String makePostOrder(String inorder) {
		...
		sb.append('/'); // 마지막 피연산자도 구분자 만들기 위함
		// 남은거 넣기
		while(!stack.isEmpty()) {
			sb.append(stack.pop());
		}
